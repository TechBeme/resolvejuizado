...
### 🚀 Precisa de Automação, IA ou Integração?

Especializado em **pipelines de dados**, **automação com IA**, **web scraping** e **integrações complexas**.

Desenvolvedor Full Stack com expertise em:
- 🔄 **Automação**: Pipelines de dados, ETL, processamento em lote
- 🌐 **Web Scraping**: Firecrawl, Puppeteer, APIs REST
